...
- **Frontend**: Vite + React 19 + TypeScript + Tailwind CSS v4 + React Query + Recharts + react-grid-layout
...
| **v2** | Widget System (done) | Widget grid (`react-grid-layout`), drag & drop, resize, asset + time widgets, edit mode |
